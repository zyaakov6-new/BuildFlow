...
const steps = [
  {
    ...
    description:
      "מחבר את Google Calendar או Apple Calendar שלך. BondFlow מוצאת את החלונות הממשיים בשבוע שלך - בין איסוף מהגן, עבודה, ארוחת ערב ושינה. גם 15 דקות נחשבות.",
  ...
  },
  {
    ...
    description:
      "תספר לנו פעם אחת את גיל הילדים, תחביבים, רמת אנרגיה. BondFlow מציעה פעילויות שמתאימות עכשיו - ההתמכרות הנוכחית של הילד, חגים. לא פארק גנרי. רעיונות אמיתיים, ספציפיים, אפס הכנה.",
  ...
  },
  {
    ...
    description:
      "ראית הצעה שאהבת? לחיצה אחת וזה ביומן. מקבל תזכורת עדינה. לא עוד \"התכוונתי אבל שכחתי.\"",
  ...
  },
  {
    ...
    description:
      "כל יום ראשון - ראה את הניצחונות שלך. הרגעים שיצרת. צפה בציון שעולה. צפה באשמה שנעלמת. \"השבוע: 4 רגעים משפחתיים. הופעת.\"",
    color: "oklch(0.72 0.18 42)",
    bgColor: "oklch(0.92 0.06 60 / 0.2)",
  },
];
